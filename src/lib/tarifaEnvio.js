...
export const TRAMOS_ENVIO = [
  { desde: 27000, nombre: '3+ tragos · $27.000+', aporte: 3000, zonas: [{ hasta: 8, tarifa: 0 }, { hasta: 15, tarifa: 3000 }] },
  { desde: 18000, nombre: '2 tragos · $18.000+', aporte: 1500, zonas: [{ hasta: 6, tarifa: 3000 }, { hasta: 13, tarifa: 4000 }] },
  { desde: 0, nombre: '1 trago · menos de $18.000', aporte: 0, zonas: [{ hasta: 4, tarifa: 3000 }, { hasta: 8, tarifa: 4000 }] },
]
...
export function tarifaEnvio(monto, km, costoUber) {
  ...
  const calc = (t) => {
    ...
    return { dentro: false, tarifa: Math.max(borde, arriba500(costo - t.aporte)), costoUsado: costo, estimado: !real }
  }
  const r = { tramo, aporte: tramo.aporte, ...calc(tramo) }
